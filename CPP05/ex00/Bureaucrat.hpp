...
class Bureaucrat
{
	...
	public:
		...
		/* void printGradeTooHighException() const; // Prints an error message if the grade is too high
		void printGradeTooLowException() const; // Prints an error message if the grade is too low */
